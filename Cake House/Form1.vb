Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'PpDataSet.Test_TB' table. You can move, or remove it, as needed.
        Me.Test_TBTableAdapter.Fill(Me.PpDataSet.Test_TB)
        'TODO: This line of code loads data into the 'PpDataSet.Test_TB' table. You can move, or remove it, as needed.
        Me.Test_TBTableAdapter.Fill(Me.PpDataSet.Test_TB)
        Timer1.Enabled = True
    End Sub
